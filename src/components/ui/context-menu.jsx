...
const ContextMenuItem = React.forwardRef((props, ref) => {
  ...
  return (
    <ContextMenuPrimitive.Item
      ref={ref}
      className={cn(
        "flex items-center rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-accent",
        inset && "pl-8",
        className
      )}
      {...rest}
...
const ContextMenuCheckboxItem = React.forwardRef((props, ref) => {
  ...
  return (
    <ContextMenuPrimitive.CheckboxItem
      ref={ref}
      className={cn(
        "relative flex items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-accent",
        className
      )}
      checked={checked}
      {...rest}
